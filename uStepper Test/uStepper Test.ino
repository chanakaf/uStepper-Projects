...
void setup(void)
{
	...
	stepper.setMaxAcceleration(1000);		//use an acceleration of 2000 fullsteps/s^2
	stepper.setMaxVelocity(500);			//Max velocity of 800 fullsteps/s
	stepper.setHoldCurrent(0);				//Set hold current %
	stepper.setCurrent(30);					//Set operating current %
